...
| expand | session turn [--before N] [--after N] | Classifier lines (index, role, type, chars) around an anchor turn, REQ markers interleaved; before/after default 30 with a HARD FLOOR of 30 — only larger allowed, never filtered |
